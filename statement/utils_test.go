...
func TestValueToNamedValue(t *testing.T) {
	...
	utils.AssertEqual(namedValues[0].Ordinal, 1, t, "Ordinal must be 1-based per driver.NamedValue")
	utils.AssertEqual(namedValues[1].Ordinal, 2, t, "Ordinal must be 1-based per driver.NamedValue")
